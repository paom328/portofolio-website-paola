function Calculate(){
    ...
    if(!isNaN(result)){
        ...
        if(result < 18.5){
            document.getElementById("bmi-status").innerHTML = "Bajo de peso";
        }
        else if(result < 25){
            document.getElementById("bmi-status").innerHTML = "Normal";
        }
        else if(result < 30){
            document.getElementById("bmi-status").innerHTML = "Sobrepeso";
        }
        else{
            document.getElementById("bmi-status").innerHTML = "Obesidad";
        }
    }
}
